...
<div><div style={{fontFamily:F.mono,fontSize:"7px",letterSpacing:"0.5em",textTransform:"uppercase",color:C.lime,marginBottom:"2px"}}>A KHG HugLife Event</div><span style={{fontFamily:F.display,fontSize:"20px",fontWeight:700,fontStyle:"italic",color:C.cream,letterSpacing:"0.04em"}}>Pawchella</span></div><div className="nl" style={{display:"flex",gap:"24px",alignItems:"center"}}><a href="#tickets" style={{fontFamily:F.sans,fontSize:"10px",fontWeight:700,letterSpacing:"0.12em",textTransform:"uppercase",color:C.base,background:C.lime,padding:"10px 24px",textDecoration:"none",display:"inline-block"}}>Get Tickets</a></div></nav>);}
